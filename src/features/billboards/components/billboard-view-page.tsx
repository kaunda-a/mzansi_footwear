...
import { Billboard } from "@/components/catalog/billboard/billboard";
...
export function BillboardViewPage({ billboardId }: BillboardViewProps) {
  ...
  const isExpired =
    billboard.endDate && new Date(billboard.endDate) < new Date();
  const isScheduled =
    billboard.startDate && new Date(billboard.startDate) > new Date();
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p>
                {billboard.creator.firstName} {billboard.creator.lastName}
              </p>
              <p className="text-sm text-muted-foreground">
                {billboard.creator.email}
              </p>
            </div>
