        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {message.type === "INFO" &&
                  "General announcements and information sharing"}
                {message.type === "SUCCESS" &&
                  "Celebrating achievements or successful operations"}
                {message.type === "WARNING" &&
                  "Alerting users to potential issues or changes"}
                {message.type === "ERROR" &&
                  "Notifying about system errors or problems"}
                {message.type === "ALERT" &&
                  "Urgent notifications requiring immediate attention"}
                {message.type === "PROMOTION" &&
                  "Marketing campaigns and promotional offers"}
                {message.type === "SYSTEM" &&
                  "System maintenance and technical updates"}
                {message.type === "INVENTORY" &&
