...
const typeStyles: Record<string, string> = {
  PROMOTIONAL:
    "bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-200",
  ANNOUNCEMENT:
  ...
  SEASONAL:
    "bg-gradient-to-r from-yellow-500/10 to-amber-500/10 border-yellow-200",
  SYSTEM_MESSAGE:
              ...
              <div className="flex items-center space-x-2">
                ...
                {currentBillboard.endDate && (
                  <Badge variant="secondary" className="text-xs">
                    Expires{" "}
                    {new Date(currentBillboard.endDate).toLocaleDateString()}
                  </Badge>
                )}
              </div>
              ...
              <div className="flex items-center space-x-2">
                {currentBillboard.linkUrl && (
                  <Button
                    size="sm"
                    onClick={() =>
                      window.open(currentBillboard.linkUrl!, "_blank")
                    }
