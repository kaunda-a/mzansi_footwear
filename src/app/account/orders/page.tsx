...
export const metadata: Metadata = {
  ...
  description:
    "Track and manage your orders, view order history and tracking information at Mzansi Footwear.",
  keywords:
    "orders, tracking, order history, purchases, account, Mzansi Footwear",
};
