...
export const metadata: Metadata = {
  ...
  description:
    "Discover premium South African footwear for every occasion. Quality craftsmanship, authentic designs, and exceptional comfort.",
  keywords:
    "South African footwear, premium shoes, authentic designs, quality craftsmanship, Mzansi fashion",
  robots: {
    index: true,
    follow: true,
    googleBot: {
