...
export const metadata: Metadata = {
  ...
  description:
    "Learn about our shipping options, delivery times, and costs for Mzansi Footwear orders.",
  keywords:
    "shipping, delivery, shipping costs, delivery times, Mzansi Footwear",
};
              ...
              <div className="container mx-auto px-4 py-8 max-w-4xl">
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  <p className="text-lg text-muted-foreground">
                    Everything you need to know about shipping and delivery for
                    your Mzansi Footwear orders.
                  </p>
                  ...
                  <p>
                    We deliver to all major cities and towns across South
                    Africa, including:
                  </p>
                  <ul>
                  ...
                  <p>
                    ...
                    via email. You can also track your order by logging into
                    your account.
                  </p>
                  ...
                  <p>
                    ...
                    during delivery hours. If no one is available, the courier
                    will leave a notice for redelivery.
                  </p>

                  <h2>Questions?</h2>
                  <p>
                    For shipping-related questions, contact us at
                    shipping@mzansifootwear.com
                  </p>
                </div>
              </div>
            </Suspense>
