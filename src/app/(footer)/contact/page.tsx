                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-muted-foreground">info@mzansifootwear.com</p>
                        </div>
                        
                        <div>
                          <h3 className="font-medium">Customer Support</h3>
                          <p className="text-muted-foreground">support@mzansifootwear.com</p>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            Check our <a href="/faq" className="text-primary hover:underline">FAQ page</a> for quick answers.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            Visit our <a href="/returns" className="text-primary hover:underline">Returns page</a> for return policies.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            Learn about our <a href="/shipping" className="text-primary hover:underline">shipping options</a>.
                          </p>
                        </div>
                      </div>
                    </div>
