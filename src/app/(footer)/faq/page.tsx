            ...
            <Suspense fallback={<DataTableSkeleton columnCount={1} />}>
              <div className="container mx-auto px-4 py-8 max-w-4xl">
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    Simply browse our products, select your size and preferred items, add them to your cart, 
                    and proceed to checkout. You can pay using credit card, debit card, or EFT.
                  </p>

                  <h3>Can I modify or cancel my order?</h3>
                  <p>
                    You can modify or cancel your order within 1 hour of placing it. After that, 
                    your order will be in processing and cannot be changed.
                  </p>

                  <h3>What payment methods do you accept?</h3>
                  <p>
                    We accept all major credit cards (Visa, Mastercard), debit cards, and EFT payments. 
                  ...
                  <p>
                    ...
                    Free shipping (on orders over R1000) takes 3-5 business days.
                  </p>

                  <h3>Do you ship nationwide?</h3>
                  <p>
                    Yes, we ship to all major cities and towns across South Africa. 
                    Check our shipping page for more details.
                  </p>

                  <h3>How can I track my order?</h3>
                  <p>
                    Once shipped, you'll receive a tracking number via email. You can also track 
                  ...
                  <p>
                    Contact us at returns@mzansifootwear.com with your order number. 
                    We'll provide a prepaid return label and instructions.
                  </p>

                  <h3>Can I exchange for a different size?</h3>
                  <p>
                    Yes, we offer free size exchanges within 30 days. Follow our return process 
                    and indicate you'd like an exchange.
                  </p>
                  ...
                  <p>
                    Use our size guide available on each product page. If you're between sizes, 
                    we recommend going up a half size for comfort.
                  </p>

                  <h3>Are your products authentic?</h3>
                  <p>
                    Yes, all our products are 100% authentic. We source directly from 
                  ...
                  <p>
                    Email us at support@mzansifootwear.com or visit our contact page. 
                  ...
                  <p>
                    ...
                    customer support team at support@mzansifootwear.com
                  </p>
                </div>
              </div>
            </Suspense>
